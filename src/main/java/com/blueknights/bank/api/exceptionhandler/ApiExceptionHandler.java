...
import com.blueknights.bank.domain.exception.BusinessException;
import com.blueknights.bank.domain.exception.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String USER_GENERIC_ERROR_MESSAGE = "Ocorreu um erro interno inesperado no sistema. "
	...
	public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
		...
		String detail = USER_GENERIC_ERROR_MESSAGE;
...
//	}
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers,
		...
		Problem problem = createProblemBuilder(status, problemType, detail).userMessage(USER_GENERIC_ERROR_MESSAGE)
				.build();
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if (body == null) {
			body = Problem.builder().timestamp(OffsetDateTime.now()).title(status.getReasonPhrase())
					.status(status.value()).userMessage(USER_GENERIC_ERROR_MESSAGE).build();
		} else if (body instanceof String) {
			body = Problem.builder().timestamp(OffsetDateTime.now()).title((String) body).status(status.value())
					.userMessage(USER_GENERIC_ERROR_MESSAGE).build();
		}
